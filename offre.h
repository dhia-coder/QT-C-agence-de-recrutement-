...
{
protected:
    int experience,NHeures,age_max,salaire,NJconge;
    QDate datepub;
    char sexe,etat;
   QString id,domaine,competance,niveau;


public:
    offre();
    offre(QString);
    offre(QString,QDate,QString,QString,QString,int,int,char,int,int,int,char);
