...
if(check){
    ...
    model->setHeaderData(0,Qt::Horizontal,QObject::tr("date de expiration"));
    model->setHeaderData(1,Qt::Horizontal,QObject::tr("Domaine"));
    model->setHeaderData(2,Qt::Horizontal,QObject::tr("competance"));

    model->setHeaderData(3,Qt::Horizontal,QObject::tr("niveau"));
    model->setHeaderData(4,Qt::Horizontal,QObject::tr("NB_years of experience" ));
    model->setHeaderData(5,Qt::Horizontal,QObject::tr("NBHEURES"));
